...
public class AddLongLat {
  public static void main(String[] args) throws Exception {
    // 1. Open het bestand
    // String inputFile = "F:\\dev\\Tools\\OSMMapper\\src\\test\\resources\\Hoevelaken-adressenlijst.xlsx";
    // String inputFile = "F:\\dev\\Tools\\OSMMapper\\src\\test\\resources\\Hoevelaken-Buitenadressenlijst.xlsx";
    String inputFile = "F:\\dev\\Tools\\OSMMapper\\src\\test\\resources\\hoevelaken-warmtescan.xlsx";
    // String outputFile =
    // "F:\\dev\\Tools\\OSMMapper\\src\\test\\resources\\Hoevelaken-adressenlijst_met_coordinaten.xlsx";
    String outputFile = "F:\\dev\\Tools\\OSMMapper\\src\\test\\resources\\Hoevelaken-warmtescan_met_coordinaten.xlsx";
        ...
        if (rowIndex == 0) {
          ...
          for (Cell cell : row) {
            ...
            if (type == CellType.STRING) {
              ...
              } else if (cellIndex == 2 && !value.isEmpty()) { // toevoeging
          ...
          if (l_address.getRoad() != null && l_address.getHouseNumber() != null) {
            ...
            // postcode huisnummer toevoeging straat plaats Aantal P Geb
            Cell postCell = row.getCell(9);
            if (postCell == null) {
              postCell = row.createCell(9);
            }
            postCell.setCellValue(l_address.getPostcode());

            postCell = row.getCell(10);
            if (postCell == null) {
              postCell = row.createCell(10);
            }
            postCell.setCellValue(l_address.getHouseNumber());

            postCell = row.getCell(11);
            if (postCell == null) {
              postCell = row.createCell(11);
            }
            postCell.setCellValue(l_address.getRoad());

            postCell = row.getCell(12);
            if (postCell == null) {
              postCell = row.createCell(12);
            }
            postCell.setCellValue(l_address.getCity());
